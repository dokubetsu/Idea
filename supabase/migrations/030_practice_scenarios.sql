...
DO $$ BEGIN
  CREATE TYPE public.practice_difficulty AS ENUM ('beginner', 'intermediate', 'advanced');
EXCEPTION
  WHEN duplicate_object THEN NULL;
END $$;

DO $$ BEGIN
  CREATE TYPE public.practice_session_status AS ENUM ('active', 'completed', 'abandoned');
EXCEPTION
  WHEN duplicate_object THEN NULL;
END $$;
...
DROP POLICY IF EXISTS "practice_decisions:insert_own" ON practice_decisions;
