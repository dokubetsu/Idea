...
-- 1. matters indexes
CREATE INDEX IF NOT EXISTS idx_matters_deleted_at ON public.matters(deleted_at);
...
CREATE INDEX IF NOT EXISTS idx_lawyer_profiles_free_consult ON public.lawyer_profiles(offers_free_consultation);

-- 6. hearings indexes
CREATE INDEX IF NOT EXISTS idx_hearings_reminder_sent ON public.hearings(reminder_sent);
